...
namespace Shared
{
    static public class RabbitMQSettings
    {
        ...
        public const string Order_PaymentCompletedEventQueue = "order-payment-completed-event-queuq";
        public const string Order_StockNotReservedEventQueue = "order-stock-not-reserved-event-queue";
        public const string Order_PaymentFailedEventConsumer = "order-payment-failed-event-queue";
    }
}
